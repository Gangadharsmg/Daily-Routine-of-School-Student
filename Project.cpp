...
void display()
{
	...
	drawText(300,1100,0,1,1,"CHANNABASAVESHWARA INSTITUTE OF TECHNOLOGY, GUBBI");


	drawText(320,1000,1,1,1,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	drawText(480,900,1,0,1," Computer Graphics Mini Project");
	drawText(600,850,0,0,0," On");


	drawText(440,780,1,1,0,"\"DAILY ROUTINE OF SCHOOL STUDENT\"");
	drawText(540,690,0,0,0,"DEVELOPED BY:");

	drawText(550,620,1,1,1,"GANGADHAR S");
	drawText(560,550,1,1,1,"(1CG15CS027)");

	drawText(200,490,1,0,0,"GUIDE:");
	drawText(1000,480,1,0,0,"HOD:");
	drawText(200,430,1,1,1,"Mr. Dharanesh Kumar M L  M.Tech.,");
	drawText(200,380,1,1,1,"Asst Professor,");
	drawText(200,320,1,1,1,"Dept. of CSE, CIT, Gubbi");

	drawText(900,430,1,1,1,"Dr. Shantala C P Ph.D");
	drawText(900,380,1,1,1,"Vice Principal & HOD,");
	drawText(900,310,1,1,1,"Dept. of CSE, CIT, Gubbi");




	drawText(450,150,0,1,0,"PRESS 'x' FOR MANUAL PAGE");
	glFlush();
...
void main(int argc, char **argv)
{
	...
	glutCreateWindow("Daily Routine of School Student");	
